...
'''
XXX ==> Only Super class : Animal,Employee : 
                           Unnecessarily other behavior also will come to our object

XXX ==> Only Sub classes : Code duplication. 
                           For example one method is common for all classes,
                            then code duplication will happen
