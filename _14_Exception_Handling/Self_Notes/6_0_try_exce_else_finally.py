...
try:
    ...
    print("In EXCEPT :: You are trying to divide by Zero.Please enter value other than 0 : ")
else:
...
# Once exception happens,further statements will not be executed in try block
