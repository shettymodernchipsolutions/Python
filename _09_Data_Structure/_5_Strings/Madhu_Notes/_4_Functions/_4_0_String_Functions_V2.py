...
#8. find() : returns the index (within mentioned limits) \n returns -1 if not found.
...
print("index of lec,if present in Hannibal\tLecter between index 3 & 14      :", str2.find("lec", 3, 14))
print("index of peak,if present in chesapeake ripper between index 8 & 12    :", str1.find("peak", 8, 12))
print("-------------------------------------------------------------------------------------")
