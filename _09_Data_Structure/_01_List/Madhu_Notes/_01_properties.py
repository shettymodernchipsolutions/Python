...
list1 = [1, 1, 2, 3, 4, 5, 6]
print("_01_List data structure :", list1)
...
_01_List properties:
==================
# 1. _01_List will allow both homogeneous and heterogenous data
# 2. _01_List allows duplicate elements
# 3. Insertion order maintains
# 4. Follows indexing mechanism while storing elements
# 5. _01_List is mutable*
...
# 4. _01_List is mutable
print("----_01_List is MUTABLE-----")
