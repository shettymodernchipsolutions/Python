...
1. First 2 postions, firstname,lastname
2. 3,4th postions, location, mobileno swapping
3. (917) 958-1191 <== 9179581191
4. Search names can be either lowercase or uppercase
5. User can either gives firstname or lastname. But we have to display results for all
