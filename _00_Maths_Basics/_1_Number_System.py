...
Sets, Sequences, Matrices                  ==> Data Structures ==> String _01_List Tuple Dictionary Set
'''
'''
Number System
=====================
...
Sets, Sequences, Matrices   ==>   Adv topics      ====> Data Structures(String, _01_List, Tuple, Dictionary, Set)
...
==>Data structures --> Collection(Group) of individual values 
    ...
    --> String, _01_List, Tuple, Dictionary, Set       
